...
export const listNotifications = (params: { page: number; size: number }) =>
  axiosIns.get<unknown, BaseResponse<NotificationPageResponse>>('/auth/notifications', { params })

export const listTodos = (params: { page: number; size: number }) =>
  axiosIns.get<unknown, BaseResponse<NotificationPageResponse>>('/auth/notifications/todos', { params })
