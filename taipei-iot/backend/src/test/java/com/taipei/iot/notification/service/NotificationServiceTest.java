...
class NotificationServiceTest {
    ...
    void listTodos_shouldReturnOnlyTodoType() {
        ...
        Page<NotificationEntity> page = new PageImpl<>(List.of(entity), PageRequest.of(0, 20), 1);
        when(notificationRepository.findByUserIdAndTypeOrderByCreatedAtDesc("u1", NotificationType.TODO, PageRequest.of(0, 20)))
                .thenReturn(page);
    ...
    @Test
    void markRead_shouldSetReadTrueAndReadAt() {
        NotificationEntity entity = buildEntity(1L, "u1", NotificationType.INFO, false);
    ...
    void markRead_shouldThrowWhenNotFound() {
        ...
        BusinessException ex = assertThrows(BusinessException.class,
                () -> notificationService.markRead("u1", 999L));
    ...
    @Test
    void markRead_shouldSkipIfAlreadyRead() {
