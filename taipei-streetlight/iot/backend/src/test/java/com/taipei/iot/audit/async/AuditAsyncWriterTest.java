...
class AuditAsyncWriterTest {
    ...
    void saveAsync_shouldPersistEntity() {
        ...
        auditAsyncWriter.saveAsync(
                "tenant-100", "u-admin-001", "admin@test.com",
                "LOGIN", "USER_AUTH",
                "/v1/noauth/token", "{}", "00000",
                "192.168.1.100", "Mozilla/5.0", 120L, 100L
        );
    ...
    void saveAsync_shouldNotThrowOnDbFailure() {
        when(userEventLogRepository.save(any()))
    ...
    void saveAsync_shouldHandleNullTenantId() {
        ...
        auditAsyncWriter.saveAsync(
                null, "u-super-001", "super@test.com",
                "CREATE_MENU", "SYSTEM",
                "/v1/auth/menus", "{}", "00000",
                "10.0.0.1", "Mozilla/5.0", 80L, null
        );
