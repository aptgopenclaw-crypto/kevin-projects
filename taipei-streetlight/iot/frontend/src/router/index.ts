...
const noauthRoutes = [
  ...
  {
    path: '/public/repair',
    name: 'PublicRepairForm',
    component: () => import('@/views/public/PublicRepairFormView.vue'),
    meta: { requiresAuth: false },
  },
  {
    path: '/public/repair/status',
    name: 'PublicRepairStatus',
    component: () => import('@/views/public/PublicRepairStatusView.vue'),
    meta: { requiresAuth: false },
  },
]
