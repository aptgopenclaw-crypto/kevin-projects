...
public class WorkflowController {
    ...
    public BaseResponse<PageResponse<WorkflowInstanceResponse>> getPendingTasks(
        ...
        Page<WorkflowInstanceResponse> result = workflowService.getMyPendingTasks(userId,
    ...
    public BaseResponse<Void> transition(@PathVariable Long instanceId,
        ...
        String userId = SecurityContextUtils.getCurrentUserId();
        workflowService.transition(instanceId, request.getTargetStep(), request.getAction(),
                userId, null, request.getComment(), request.getAttachments());
